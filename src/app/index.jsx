...
export default function Index() {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={[styles.button, styles.secondaryButton]} onPress={() => router.push('/userProfile')}>
        <Text style={styles.secondaryButtonText}>User Profile</Text>
      </TouchableOpacity>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: '#007AFF', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 8, marginVertical: 8, width: '80%', alignItems: 'center' },
